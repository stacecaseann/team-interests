...
const getAllSpeakers = async (req, res) => {
    try {
        ...
        return res.status(500).json({error: "There was an error while getting your speaker"});
    }
};
...
const createSpeaker = async (req, res) => {
    try {
        ...
        return res.status(500).json({error: "There was an error while creating your speaker"})
    }
}
...
const updateSpeaker = async (req, res) => {
    ...
    try {
        const result = await Speaker.findByIdAndUpdate(
            id,
            req.body,
        ...
        return res.status(500).json({error: "There was an error while updating your speaker"})
    }
}
...
const deleteSpeaker = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json({message: "Your speaker was deleted", speaker: result})
    } catch (error) {
        return res.status(500).json({error: "There was an error while deleting your speaker"})
    }
}
